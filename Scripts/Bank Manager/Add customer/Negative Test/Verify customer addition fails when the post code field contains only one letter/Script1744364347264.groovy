...
WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Object Repository/Bank Manager/Add customer/input_Post Code_form-control ng-pristine ng_b8fd27'), 'value'), 'A', FailureHandling.CONTINUE_ON_FAILURE)
