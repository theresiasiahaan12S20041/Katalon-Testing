...
WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Object Repository/Bank Manager/Add customer/input_Last Name_form-control ng-untouched n_0d6055'), 'value'), 'V', FailureHandling.CONTINUE_ON_FAILURE)
