...
// Open browser
WebUI.callTestCase(findTestCase('Bank Manager/Login/Verify successful bank manager login'), [:], FailureHandling.STOP_ON_FAILURE)
...
// Verify that the value of the 'Last Name' input field is the same as the entered value (Add customer failed)
WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Object Repository/Bank Manager/Add customer/input_Last Name_form-control ng-untouched n_0d6055'), 'value'), 'Valley^%$#.,', FailureHandling.CONTINUE_ON_FAILURE)
