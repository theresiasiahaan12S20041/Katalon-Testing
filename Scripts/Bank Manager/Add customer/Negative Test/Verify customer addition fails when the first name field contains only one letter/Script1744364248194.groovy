...
WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Object Repository/Bank Manager/Add customer/input_First Name_form-control ng-pristine n_693e51'), 'value'), 'L', FailureHandling.CONTINUE_ON_FAILURE)
