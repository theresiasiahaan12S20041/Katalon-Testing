...
// Verify that the page comeback to the home page
WebUI.verifyElementVisible(findTestObject('Object Repository/Customer/Validate customer login/welcome_text'))
